...
<footer>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4  col-md-2 col-sm-8 col-xs-12">
                  <img src="<?php echo base_url('public/imagenes/logo-footer.png')?>" alt="..." class="img-rounded img-responsive">
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="pull-left"> Copyright © AstroxSoluction 2016. All right reserved. </p>
